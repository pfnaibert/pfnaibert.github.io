...
```{r}
# Import
PIB <- read.csv("../../_resources/data/PIB_BASE_2000.csv")
...
recs2 <-c(1981.25, 1983.25, 1987.75, 1988.75, 1989.75, 1992.25, 1995.5, 1995.75, 1998.25, 1999.25, 2001.5, 2002, 2003.25, 2003.5, 2009, 2009.25 )
```
